...
const MOCK_DRIVER_NOTIFICATIONS = [
  {
    id: '1',
    type: 'JOB',
...
const MOCK_CUSTOMER_NOTIFICATIONS = [
  {
    id: 'c1',
    type: 'JOB',
    title: 'Driver Assigned',
    body: 'Ramesh is on the way to pickup your load.',
    timeAgo: 'Just now',
    isRead: false,
    action: 'Track Driver',
  },
  {
    ...
    body: 'Your truck booking has been successfully confirmed.',
    timeAgo: '10 mins ago',
    isRead: true,
  },
  {
    ...
    body: '₹450 deducted for your last trip.',
    timeAgo: 'Yesterday',
    isRead: true,
  },
];
